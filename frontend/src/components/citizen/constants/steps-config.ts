...
export const STEPS = [
  ...
  },
  {
    ...
    fields: [
      ...
      "proxy.pesel",
      "proxy.identityType",
      "proxy.identitySeries",
      "proxy.identityNumber",
      "proxy.address.street",
      "proxy.address.houseNumber",
      "proxy.address.zipCode",
      "proxy.address.city",
    ],
  ...
  },
  {
    ...
    fields: ["accident.date", "accident.time", "accident.location", "accident.plannedWorkStart", "accident.plannedWorkEnd"],
  ...
  },
  {
    ...
    fields: [
      "witness.name",
      "witness.testimony",
      "witness.address.street",
      "witness.address.houseNumber",
      "witness.address.zipCode",
  ...
  },
  {
    ...
    fields: ["accident.detailedDescription", "accident.activitiesBeforeAccident", "accident.causeDescription"],
